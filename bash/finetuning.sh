...
#sbatch --time 1-00:00:00 --job-name M7IV1-finetuning --output=${slurm_folder}/$language/Minerva-7B-instruct-v1.0.out bash/_finetuning[new].sh sapienzanlp/Minerva-7B-instruct-v1.0 "_M7IV1" "$language"
#__________________________________________________________________#
